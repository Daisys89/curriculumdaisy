<template>
  <div class="min-h-screen bg-gray-50">
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-r from-teal-500 to-cyan-600 py-20">
      <!-- Background Pattern -->
    ...
    <div class="max-w-6xl mx-auto px-6 py-16">
      ...
      <section class="mb-20">
        <div class="text-center mb-12">
          ...
          <div
            class="w-24 h-1 bg-gradient-to-r from-teal-500 to-cyan-500 mx-auto rounded-full"
          ></div>
        </div>
            ...
            <div class="p-6">
              ...
              <div class="flex flex-wrap gap-2">
                <span
                  ...
                  :key="tech"
                  class="px-3 py-1 bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-800 text-sm font-medium rounded-full"
                >
                  {{ tech }}
                </span>
              </div>
    ...
    <section class="bg-gradient-to-r from-teal-500 to-cyan-600 py-20">
      <div class="max-w-4xl mx-auto text-center px-6">
        <h2 class="text-4xl font-bold text-white mb-6">Klaar om samen te werken?</h2>
        <p class="text-xl text-teal-100 mb-8">Laten we jouw volgende project tot leven brengen!</p>

        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="mailto:people@wearetheguild.net"
          ...
          <a
            href="#"
            class="px-8 py-3 border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-teal-600 transition-all duration-200"
          >
            Download CV
          </a>
        </div>
  ...
  data() {
    return {
      ...
      skillCategories: [
        ...
        {
          name: 'Database & Tools',
          skills: [{ name: 'Firebase' }, { name: 'REST API' }],
        },
      ],
      experience: [
        {
        ...
        },
        {
          ...
          period: '2019 - 2022',
          description:
            'Verantwoordelijk om al het trainingsmateriaal op één plek beschikbaar te maken voor het team. Verzamelen van alle informatie van de verschillende servers en folders, controleren of informatie nog correct is en het op de interne website plaatsen. Ervoor zorgen dat team op de hoogte is van nieuw en/of gewijzigd materiaal. Team coachen op gesprekken en case management, 2 à 3 gesprekken afluisteren en case in systeem controleren, feedback in persoon bespreken.',
